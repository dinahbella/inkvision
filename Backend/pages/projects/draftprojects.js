...
export default function DraftProject() {
  ...
  const currentProject = filteredBlogs.slice(indexOfFirstBlog, indexOfLastBlog);

  // Filter published blogs
  const publishedBlogs = currentProject.filter((ab) => {
    console.log("Project Status:", ab.status); // Debugging
    ...
    <div className="blogspage">
      <div className="titledashboard flex flex-sb">
        ...
        <div className="breadcrumb">
          <SiBloglovin /> <span>/</span> <span>Draft Project</span>
        </div>
      </div>
